...
function state(rules: Rule[] = []): GameState {
  return {
    ...
    items: [], turn: 12, activeEntityId: 'player', seed: 1, rngCounter: 0, rules, xp: 0, level: 1, depth: 1, gold: 0, story: '', motif: null, bodies: [], bible: null, smoke: null, traps: [], alarm: null, unveiled: [],
  };
}
